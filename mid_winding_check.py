...
available_radial_build = st.sidebar.number_input("Available Radial Build Space (mm)", min_value=0.1, value=141.0, step=0.1)
...
if unit_mode == "Imperial (thou)":
    ...
    nominal_cu = st.sidebar.number_input("Actual Cu Thickness (mm)", min_value=0.0001, value=0.7874, format="%.4f")
